...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        int[] array = Arrays.stream(scanner.nextLine().split(" "))
                ...
                .toArray();
        BiFunction<Integer, Integer, Integer> comparatorMin = Integer::min;
        BiFunction<Integer, Integer, Integer> comparatorMax = Integer::max;

        if (isAscending) {
            sort(array, comparatorMin);
        } else {
            sort(array, comparatorMax);
        }
